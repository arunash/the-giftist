...
export function SuggestionCard({ suggestion }: SuggestionCardProps) {
  return (
    <div className="bg-white rounded-xl border-2 border-accent/30 p-4 hover:border-accent/60 transition">
      <div className="flex items-start gap-3">
        ...
        <div>
          ...
          <h3 className="font-medium text-secondary text-sm">{suggestion.title}</h3>
