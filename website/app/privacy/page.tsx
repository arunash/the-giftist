        ...
        <div className="space-y-8 text-sm leading-relaxed">
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-1">
              <li><strong className="text-white">Account information:</strong> Name, email address, phone number (when you sign up via Google or WhatsApp)</li>
              <li><strong className="text-white">Profile preferences:</strong> Birthday, gender, age range, interests, gift budget, relationship/household status</li>
              <li><strong className="text-white">Wishlist data:</strong> Product URLs, item names, prices, images, and categories you add to your lists</li>
              <li><strong className="text-white">Event data:</strong> Event names, types, dates, descriptions, and associated items</li>
              <li><strong className="text-white">Messages:</strong> Chat conversations with our AI concierge (via web and WhatsApp)</li>
              <li><strong className="text-white">Payment information:</strong> Processed securely by Stripe; we do not store full credit card numbers</li>
            </ul>

            <h3 className="font-semibold text-white mt-4 mb-2">2.2 Information Collected Automatically</h3>
            <ul className="list-disc pl-6 space-y-1">
              <li><strong className="text-white">Usage data:</strong> Pages visited, features used, interactions with the AI concierge, timestamps</li>
            ...
            <h3 className="font-semibold text-white mt-4 mb-2">2.3 Information from Third Parties</h3>
            <ul className="list-disc pl-6 space-y-1">
              <li><strong className="text-white">Google:</strong> Name and email address when you sign in with Google</li>
              <li><strong className="text-white">WhatsApp/Twilio:</strong> Phone number and message content when you interact via WhatsApp</li>
              <li><strong className="text-white">Product URLs:</strong> Metadata scraped from URLs you submit (product names, prices, images, descriptions)</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <h3 className="font-semibold text-white mt-4 mb-2">3.1 Legal Bases for Processing (GDPR)</h3>
            <p>For users in the European Economic Area (EEA) and UK, we process personal data based on:</p>
            <ul className="list-disc pl-6 mt-2 space-y-1">
              <li><strong className="text-white">Contract performance:</strong> To provide the Service you requested (account management, wishlists, events)</li>
              <li><strong className="text-white">Legitimate interests:</strong> To improve the Service, prevent fraud, and provide relevant recommendations</li>
              <li><strong className="text-white">Consent:</strong> For marketing communications and optional profile preferences</li>
              <li><strong className="text-white">Legal obligation:</strong> To comply with applicable laws and regulations</li>
            </ul>
          </section>

          <section>
            <h2 className="text-lg font-semibold text-white mb-3">4. AI and Automated Processing</h2>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 mt-2 space-y-1">
              <li><strong className="text-white">Other users:</strong> When you share a wishlist or event publicly, the associated items and your display name are visible to anyone with the link</li>
              <li><strong className="text-white">Service providers:</strong> Third parties that help us operate the Service:
          ...
          <section>
            ...
            <ul className="list-disc pl-6 mt-2 space-y-1">
              ...
              <li><strong className="text-white">Chat history:</strong> Retained for up to 24 months to provide continuity in AI interactions</li>
              <li><strong className="text-white">Transaction records:</strong> Retained for 7 years as required by financial regulations</li>
              <li><strong className="text-white">Usage logs:</strong> Retained for 12 months for analytics and security purposes</li>
            </ul>
          ...
          <section>
            ...
            <h3 className="font-semibold text-white mt-4 mb-2">8.1 All Users</h3>
            <ul className="list-disc pl-6 space-y-1">
            ...
            <h3 className="font-semibold text-white mt-4 mb-2">8.2 California Residents (CCPA/CPRA)</h3>
            ...
            <h3 className="font-semibold text-white mt-4 mb-2">8.3 EEA/UK Residents (GDPR)</h3>
            <p>You have the right to:</p>
            <ul className="list-disc pl-6 mt-1 space-y-1">
              ...
              <li><strong className="text-white">Restriction:</strong> Request restricted processing of your data</li>
              ...
              <li><strong className="text-white">Lodge a complaint:</strong> File a complaint with your local data protection authority</li>
            </ul>
          ...
          <section>
            <h2 className="text-lg font-semibold text-white mb-3">13. GDPR Compliance Roadmap</h2>
            <p>We are actively implementing the following GDPR compliance features, planned for our next phase:</p>
            <ul className="list-disc pl-6 mt-2 space-y-1">
              <li><strong className="text-white">Cookie consent banner:</strong> Granular consent management for EEA/UK visitors</li>
              <li><strong className="text-white">Data export (portability):</strong> Self-service download of all your personal data in JSON format</li>
              <li><strong className="text-white">Account deletion:</strong> Self-service account and data deletion from the settings page</li>
              <li><strong className="text-white">Consent management:</strong> Granular controls for marketing communications, AI processing, and data sharing</li>
              <li><strong className="text-white">Data Processing Agreements:</strong> Formal DPAs with all sub-processors</li>
              <li><strong className="text-white">Privacy dashboard:</strong> A single page to view and manage all your privacy preferences</li>
            </ul>
