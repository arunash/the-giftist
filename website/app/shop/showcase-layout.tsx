...
function CarouselCard({ gift }: { gift: GiftProduct }) {
  ...
  return (
    <a
      ...
      onClick={onClick}
      data-cta="card-carousel"
      className="relative snap-start shrink-0 w-[240px] sm:w-[280px] rounded-2xl border border-gray-200 bg-white shadow-sm hover:shadow-md transition overflow-hidden flex flex-col"
    >
      ...
      <div className="p-3 flex-1 flex flex-col justify-between">
        ...
        <button
          type="button"
          className="mt-3 w-full rounded-full bg-green-500 text-white text-sm font-semibold py-2 hover:bg-green-600 transition"
        >
          Get it →
        </button>
      </div>
...
function StoryCard({ gift }: { gift: GiftProduct }) {
  ...
  return (
    <article className="rounded-3xl border border-gray-200 bg-white shadow-sm overflow-hidden">
      <a href={href} target="_blank" rel="noopener noreferrer" onClick={onClick} data-cta="card-story">
        ...
        <div className="p-5">
          ...
          <div className="mt-4 flex items-center gap-2">
            <span className="flex-1 inline-flex items-center justify-center rounded-full bg-green-500 text-white text-base font-semibold py-3 hover:bg-green-600 transition">
              Get it now →
            </span>
          </div>
        </div>
