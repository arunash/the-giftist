    ...
    <div className="min-h-screen bg-background text-secondary">
      <div className="max-w-3xl mx-auto px-6 py-12">
        ...
        <div className="space-y-8 text-sm leading-relaxed">
          ...
          <section>
            <h2 className="text-lg font-semibold text-gray-900 mb-3">5. AI-Powered Features</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-gray-900 mb-3">6. Payments and Contributions</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-gray-900 mb-3">7. Subscriptions</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-gray-900 mb-3">8. Third-Party Links and Services</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-gray-900 mb-3">9. WhatsApp Integration</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-gray-900 mb-3">14. Governing Law and Dispute Resolution</h2>
